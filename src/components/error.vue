    ...
    async submitForm() {
      ...
      try {
        if (this.validateForm()) {
          ...
          // console.log("Response Data:", registerUser.data);
        ...
        if (error.response) {
          ...
          await Swal.fire({
            ...
            text: "This email is already registered. Please try again with a different email address or log in.",
            confirmButtonColor: "#09203e",
          });
          this.isLoading = false;
          // this.$router.push("/signPg");
          return;
